...
8. On the **iOS/iPadOS | Enrollment** page, select **Apple MDM Push Certificate**.
...
10. Under **Additional configuration** add a second key-value pair by entering the following information and then select **Next**:
