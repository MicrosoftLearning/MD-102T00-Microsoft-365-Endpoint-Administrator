...
11. Under **MDM Support**, select **86%**.
...
7. The **Group policy migration readiness** report provides information related to each setting, and the **Policy type** supported.

8. Close the **Group policy migration readiness** window.

9. Close Microsoft Edge.

**Results**: After completing this exercise, you have successfully exported a GPO and used Group Policy Analytics to validate equivalent policy settings in Intune.
